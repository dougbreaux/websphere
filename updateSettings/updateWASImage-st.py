...
web_url = 'https://wsi2st.dmv.ca.gov'
gateway_url = 'http://wsi2esbiz01t.dmv.ca.gov:7800/DMVGateway/'
static_content_url = 'http://wsi2imagez01t.dmv.ca.gov:8080'
edl_url = 'https://slingshot.edl-test.dmv.ca.gov'
design_url = 'https://cdn.uat.dmv.ca.gov/dmv-design-system/uat/'
...
_bindingsString = {
    'convergeCcGetTokenPin':'MBYJLIVEH39B21PHVGKV3PFJF99XMSEVGID25DTXMPHDIG2KG4TNCXJ1L8H7AA9Y',
...
host = '134.187.202.101'
port = '1414'
channel = 'SCART.TST.CLIENT'
queueManager = 'IIBTST01'
